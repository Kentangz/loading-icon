...
.demo-neonglitch-bar { width: 8px; height: 100%; background: var(--color-primary); border-radius: 2px; box-shadow: 0 0 6px var(--color-primary); animation: dneonglitch calc(1.0s * var(--loader-speed-scale)) ease-in-out var(--loader-cycles); }
...
@keyframes dneonglitch { 0%, 100% { transform: scaleY(0.15); opacity: 0.7; } 50% { transform: scaleY(1); opacity: 1; } 45%, 55% { transform: scaleY(0.8) skewX(8deg); filter: hue-rotate(90deg); } }`,
	},
	{
		...
		css: `.demo-pblob { width: 32px; height: 32px; background: linear-gradient(135deg, var(--color-primary), var(--color-success)); animation: dpblob 3.0s ease-in-out var(--loader-cycles); filter: drop-shadow(0 2px 5px rgba(0,0,0,0.15)); }
...
.demo-infprog::after { content: ''; position: absolute; top: -3px; left: -3px; width: 32px; height: 32px; border: 3px solid transparent; border-top-color: var(--color-primary); border-radius: 50%; animation: dinfprog 1.0s cubic-bezier(0.5, 0, 0.5, 1) var(--loader-cycles); }
...
.demo-porbit-core { width: 10px; height: 10px; background: var(--color-primary); border-radius: 50%; box-shadow: 0 0 6px var(--color-primary); animation: dporbit-core 1.2s ease-in-out var(--loader-cycles); }
.demo-porbit-ring { position: absolute; width: 32px; height: 32px; border: 2px solid transparent; border-top-color: var(--color-success); border-radius: 50%; animation: dporbit-ring 1.5s linear var(--loader-cycles); }
